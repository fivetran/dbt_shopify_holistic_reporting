{% set shopify_model = ref('shopify__customer_emails') if var('shopify_api', 'rest') == 'rest' else ref('shopify_gql__customer_emails') %}
...
with shopify_customers as (
    ...
    select
        ...
        {{ dbt_utils.star(from=shopify_model, relation_alias='shopify_customers', prefix='shopify_', quote_identifiers=false,
